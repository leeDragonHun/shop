...
<%
    System.out.println("=====customerModifyCheckAction.jsp=========================");
    ...
    if(idPwCheck){
        ...
        response.sendRedirect("/shop/customer/customerModifyOne.jsp");
    }else{
    	System.out.println("비밀번호 불일치");
    	String errMsg = URLEncoder.encode("비밀번호가 일치하지 않습니다. 다시 확인해주세요.", "UTF-8");
        response.sendRedirect("/shop/customer/customerModifycheck.jsp&errMsg="+errMsg);
    }
%>